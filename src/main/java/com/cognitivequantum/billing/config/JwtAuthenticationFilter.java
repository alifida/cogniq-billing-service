...
/**
 * Extracts user identity for ownership checks. Supports:
 * 1) X-User-Id header (set by Gateway after JWT validation) – preferred.
 * 2) Authorization: Bearer &lt;JWT&gt; – validates JWT and uses "userId" or "sub" claim.
 */
@Component
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(@NonNull HttpServletRequest request,
		...
		try {
			...
			com.cognitivequantum.billing.util.TenantContext.clear();
		}
	}
